(function() {
    var subluminositybutton = null;


    function subLuminosity() {
    ...
    function afterload() {
        subluminositybutton = document.getElementById('subluminositybutton');

        // ICI je fais le lien entre ma fonction myInert() et l'évenement click du bouton addluminositybutton
        subluminositybutton.addEventListener('click', function(ev) { subLuminosity(); }, false);
