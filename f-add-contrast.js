(function() {
    ...
    function afterload() {
        addcontrastbutton = document.getElementById('addcontrastbutton');

        // ICI je fais le lien entre ma fonction myInert() et l'évenement click du bouton addcontrastbutton
        addcontrastbutton.addEventListener('click', function(ev) { addContrast(); }, false);
